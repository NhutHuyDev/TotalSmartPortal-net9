...
namespace TotalDTO
{
    ...
    public abstract class BaseDTO : BaseModel, IAccessControlAttribute
    {
        ...
        // These properties are used as an implementation preservation of ISimpleViewModel for these
        // ________ViewModel class (Those class ________ViewModel which is BOTH inheritance from
        // this BaseDTO AND implementation of ISimpleViewModel)
        ...
        public virtual string functionNameGetReference { get; set; }
        ...
        public virtual int SaveOptionID { get; set; }
